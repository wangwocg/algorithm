...
int SWContentFilter( const char * buffer , int bufferlen, char * policynames , int nIfGetMime ,SW_EVENT_INFO *sweventinfo,int * pIfFound )
{
...
int SWFileFilter( const char * path , char * policynames ,int nIfGetMime , SW_EVENT_INFO *sweventinfo,int * pIfFound )
{
	struct list_head * mpolicy_head = NULL ;
	MPOLICY * mpolicy = NULL ;
	int length = 0 ;
